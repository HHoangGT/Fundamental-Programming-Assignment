...
void g_satc_02() { // global
    ...
    auto *config = new Configuration(
            R"(D:\\Coding\\Fundamental-Programming-Assignment\\Assignment2\\sa_tc_02_config)");
...
public:
    ...
    static void satc_01() {
        ...
        auto *sherlock = new Sherlock(1, "RUU", Position(1, 3), map, 250, 450);
        cout << sherlock->str() << endl;

        auto *watson = new Watson(2, "LU", Position(2, 1), map, 300, 350);
        cout << watson->str() << endl;

        auto *criminal = new Criminal(0, Position(7, 9), map, sherlock, watson);
        ...
        auto *arr_mv_objs = new ArrayMovingObject(10);
